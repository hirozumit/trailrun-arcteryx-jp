      ...
      <div className={styles.inner}>
        ...
        <div className={styles.body} data-reveal="clip-left">
          ...
          <p className={styles.text}>
            山への第一歩を踏み出す前の方や、今まさに踏み出しつつある方へ。アークテリクスによるトレイルランニングのための準備拠点が、代々木公園に期間限定でオープンします。本格的なトレイルランに臨む前に、山で必要となるギアや持ち物、走り方の知識などをチェックしていただけるほか、代々木公園内でトレイルランの練習におすすめのコースもご紹介。アークテリクスの最新のマウンテンラン&トレイルランニングシューズをレンタルして、公園内でお試しいただけます（有料）。
          </p>
